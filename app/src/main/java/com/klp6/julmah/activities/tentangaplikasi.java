    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notifikasi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(tentangaplikasi.this, notifikasi.class);
        ...
        pengaturan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tentangaplikasi.this, pengaturan.class);
                startActivity(intent);
            }
        });
        beranda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tentangaplikasi.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tentangaplikasi.this, profil.class);
                startActivity(intent);
            }
        });
    }
